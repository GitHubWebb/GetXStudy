 ...
 * @Date: 2023-10-30 15:25:03
 * @LastEditors: 米亚流年 miyaliunian@gmail.com
 * @LastEditTime: 2023-10-30 15:26:42
 * @FilePath: /cp_driver_app/lib/pages/my/controller/my_order_ canceled_controller.dart
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AEcele
 */
...
class MyOrderCanceledController
  ...
  void onInit() {
    super.onInit();
    initPage = Get.find<int>(tag: className(MyOrderCanceledController));
    page = initPage;
    refreshController = Get.find(tag: className(MyOrderCanceledController));
  }
