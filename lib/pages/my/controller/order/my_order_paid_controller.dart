 ...
 * @Date: 2023-10-30 15:23:11
 * @LastEditors: 米亚流年 miyaliunian@gmail.com
 * @LastEditTime: 2023-10-30 15:27:40
 * @FilePath: /cp_driver_app/lib/pages/my/controller/my_order_paid_controller.dart
...
class MyOrderPaidController
  ...
  void onInit() {
    super.onInit();
    initPage = Get.find<int>(tag: className(MyOrderPaidController));
    page = initPage;
    refreshController = Get.find(tag: className(MyOrderPaidController));
  }
