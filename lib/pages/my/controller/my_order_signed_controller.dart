 ...
 * @LastEditTime: 2023-10-31 09:47:36
 * @FilePath: /cp_driver_app/lib/pages/my/controller/my_order_signed_controller.dart
...
class MyOrderSignedController
  ...
  void onInit() {
    super.onInit();
    initPage = Get.find<int>(tag: className(MyOrderSignedController));
    page = initPage;
    refreshController = Get.find(tag: className(MyOrderSignedController));
  }
