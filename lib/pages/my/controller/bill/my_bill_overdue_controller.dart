...
class MyBillOverdueController
  ...
  void onInit() {
    ...
    initPage = Get.find<int>(tag: className(MyBillOverdueController));
    page = initPage;
    refreshController = Get.find(tag: className(MyBillOverdueController));
  }
