...
class MyBillToPaidController
  ...
  void onInit() {
    ...
    initPage = Get.find<int>(tag: className(MyBillToPaidController));
    page = initPage;
    refreshController = Get.find(tag: className(MyBillToPaidController));
  }
